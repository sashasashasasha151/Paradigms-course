...
public class ClojureEngine implements Engine {
    ...
    public ClojureEngine(final String script, final Optional<String> evaluate) {
        ...
        toString = Clojure.var("clojure.core", "toString");
    }
    ...
    public Result<Number> evaluate(final double[] vars) {
        ...
        return evaluate
                .map(f -> invoke(f, new Object[]{parsed, map}, Number.class, context))
                .orElseGet(() -> invoke(parsed, new Object[]{map}, Number.class, context));
    }
